...
public class SpringDocumentdbApplication {
	private static final Logger logger = LoggerFactory.getLogger(SpringDocumentdbApplication.class);

	public static void main(String[] args) {
		SSLContextHelper.setSslProperties();
		SpringApplication.run(SpringDocumentdbApplication.class, args);
	}
	...
	protected static class SSLContextHelper {
		...
		private static X509Certificate createCertificate(String sslCertificate) throws Exception  {
			...
			try (InputStream certInputStream = SpringDocumentdbApplication.class.getClassLoader()
